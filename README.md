# DMSkin-for-WPF 2.0
<h2>基于WPF的UI框架,全中国第一款WPF无边框完美方案,2.0采用WindowStyle.None实现</h2>
<h2>2.0 双层窗体+Win32</h2>
<h2>1.0 WindowStyle.None + 透明</h2>
...
<h2>2.0版本,采用WIN32实现无边框,2.0版本不支持圆角窗体,不支持窗体透明,但是拥有完美最小化的动画。</h2>
